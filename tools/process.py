...
def find_max_page(path, files: list) -> tuple:
    """Find max page.
...
def generate(input_folder, output_folder, label_name, label_number):
    ...
    output_filename = output_folder + '/' + 'generated_file.xlsx'
